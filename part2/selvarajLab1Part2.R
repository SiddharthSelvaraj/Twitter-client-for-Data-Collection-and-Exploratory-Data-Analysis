#Lab1 Part2
#Name : Siddharth Selvaraj UBID#:50247317
#Team Member's name: Vigneshwaran Vasanthakumar UBID#: 50248708
library(plotly)
...
library(maps)
data_maps <- data.table(read.csv(file.choose()))  #choose StateDataforMap_2017-18week4
...
geo_data <-data.table(map_data("state"))

setkey(geo_data,region)
setkey(data_map1s,region)
